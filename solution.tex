...
1000 Bayes factor in terms of Markov 0 vs Markov 1 and Markov 1 vs Markov 2 for each of the sequences are generated. The histograms are as followed. We can see that Bayes Factor favors Markov 2 over Markov 1 and Markov 1 over Markov 0.
